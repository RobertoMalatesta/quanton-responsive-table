...
<html>
    ...
    <body>
        <h1>Responsive select table</h1>
        <h2>Responsive table for mobile with single column visible. Use of select to view the desired column</h2>
        <p>
            An easy solution for the problem of using tables with small screens on mobile phones. This solution transforms an HTML table from multi column to single column. To view the other columns, this solution uses a select placed on the table cell headers.
        </p>
        <p>
            ...
            <ol>
                <li>
                    ...
                    <code>
                        ...
                        &lt;script src="table.responsive.select.js"&gt;&lt;/script&gt;<br>
                        &lt;link href="table.responsive.select.css" rel="stylesheet" /&gt;
                    </code>
                </li>
                <li>
                    Add to the table <code>class="t-r-s"</code> and an <code>id="..."</code> of your choice
                </li>
                <li>
                    On document ready call <code>var responsiveTableSelect = new ResponsiveTableSelect('my-table-1');</code> where <i>my-table-1</i> is an <code>id</code> of your choice
                </li>
            </ol>
        </p>
        ...
        <table id='my-table-1' class='t-r-s'>
            <tbody>
                <tr>
                    <th>
                        First
        ...
        <table id='my-table-2' class='t-r-s'>
            <tbody>
                <tr>
                    <th>
                        First
        ...
        <script>
            $(document).ready(function (){
                var responsiveTableSelect1 = new ResponsiveTableSelect('my-table-1');
                var responsiveTableSelect2 = new ResponsiveTableSelect('my-table-2');
            });
        </script>
    </body>
</html>
